        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">Agregar Nuevo Bien</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
            ...
            <div class="row">
                <div class="col-lg-8 mb-3 mb-lg-0">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('asset_number') is-invalid @enderror" 
                                               id="asset_number" name="asset_number" value="{{ old('asset_number') }}" 
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Descripción detallada del bien...">{{ old('description') }}</textarea>
                                @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <small class="form-text">Puede seleccionar múltiples imágenes (máx. 2MB cada una)</small>
                        </div>
                    </div>
                    <!-- End Card -->
                </div>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" 
                                    ...
                                    <option value="retired" {{ old('status') == 'retired' ? 'selected' : '' }}>Dado de Baja</option>
                                </select>
                                @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control @error('condition') is-invalid @enderror" 
                                       id="condition" name="condition" value="{{ old('condition', 'Nuevo') }}" 
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select @error('unit') is-invalid @enderror" 
                                            ...
                                            <option value="pza" {{ old('unit', 'pza') == 'pza' ? 'selected' : '' }}>Pieza</option>
                                            <option value="kg" {{ old('unit') == 'kg' ? 'selected' : '' }}>Kilogramo</option>
                                            <option value="lt" {{ old('unit') == 'lt' ? 'selected' : '' }}>Litro</option>
                                            <option value="m" {{ old('unit') == 'm' ? 'selected' : '' }}>Metro</option>
                            ...
                            <div class="mb-0">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror" 
                                          ...
                                          placeholder="Notas u observaciones...">{{ old('notes') }}</textarea>
                                @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-3">
                        <a href="{{ route('inventory.index') }}" class="btn btn-white">Cancelar</a>
                        <button type="submit" class="btn btn-primary">
                            <i class="bi-check-lg me-1"></i> Guardar Bien
                        </button>
                    </div>
                </div>
            </div>
